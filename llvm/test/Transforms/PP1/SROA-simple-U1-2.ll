; ModuleID = 'SROA-simple-U1-1.bc'
source_filename = "SROA-simple-U1-1.cpp"
...
entry:
  ...
  %s = alloca %struct.simple, align 4
  store i32 0, i32* %retval, align 4
  %a = getelementptr inbounds %struct.simple, %struct.simple* %s, i32 1, i32 0
